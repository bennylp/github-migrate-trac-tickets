...
class GitHubImport(object):
    """Connections, queries and posts to GitHub usinh special import APIs
    """
    ...
    def rate_limit(self, query=None, date=None):
        """Get rate limit
        """
        return self.access('rate_limit', query=query, data=data)
